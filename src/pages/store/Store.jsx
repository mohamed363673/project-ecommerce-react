  ...
  return (<>
    ...
    <section className='w-full h-auto flex flex-wrap justify-center items-center gap-12  py-14 '>
      {products.length > 0 ? products.map((item, i) => (
        <>
          <div key={i} idcart={item._id}  className={`card ${"product" + i} relative h-auto flex-shrink-0 lg:w-64 md:w-64 sm:w-60 w-96 p-3 rounded-lg bg-base-100 shadow-xl overflow-hidden product`}>
            <button onClick={() => {
            ...
            }} className="absolute top-3 rotate-180 right-3 btn-stare transition-all active:scale-90 p-2 rounded-lg text-white flex justify-center items-center z-20 bg-orange-500">
